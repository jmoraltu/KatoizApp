...
{
	public static string CURRENT_LANG = "English";
	private Hashtable Strings;
	public static Hashtable Countries;
	public static SortedList AppCountries;
    ...
    */
	...
	public Language (string path, string language, bool web) {
		if (!web){
			SetLanguageXML(language);
		} else {
			SetLanguageWeb(path, language);
		}
	}
	
	public Language (string language, bool web) {
		if (!web){
			SetLanguageXML(language);
		} else {
	...
	public void SetLanguageXML (string language) {
		Debug.Log("Language....." +  language);
		TextAsset textAsset = (TextAsset) Resources.Load("languages"); 
		...
		if (element != null) {
			...
			while (elemEnum.MoveNext()) {   //InvalidCastException: Cannot cast from source type to destination type.
    ...
    */
	...
	public void SetLanguageWeb (string language) {
