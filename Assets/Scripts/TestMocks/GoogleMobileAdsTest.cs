...
public class GoogleMobileAdsTest : MonoBehaviour
{
	...
	//public string url = "http://yomaker.es/ws/getadsid.php";

	/*IEnumerator readBlockId () {
		WWW www = new WWW(url);
		yield return www;
		string blockId = www.text;
		Debug.Log (blockId);
	}*/
	...
	void OnGUI()
	{
		...
		if (GUI.Button(requestBannerRect, "Request Banner 0.4"))
		{
			//JM
			RequestBanner();
		}
	...
	private void RequestBanner()
	{
		...
		//string adUnitId = "ca-app-pub-6491690976590361/3319094932"; //My Admob ads
		//string adUnitId = "/245409596/QUOAPPS_Bottom"; //Quo DBP Ads
	...
	private void RequestInterstitial()
	{
		...
		string adUnitId = "ca-app-pub-3940256099942544/1033173712"; //testing ad
		//string adUnitId = "ca-app-pub-6491690976590361/3319094932";
		//string adUnitId = "/245409596/QUOAPPS_Bottom"; //Quo DBP Ads
		#elif UNITY_IPHONE
